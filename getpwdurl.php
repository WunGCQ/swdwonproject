...
<body>
    ...
    <!--</form>-->
    <div id="container">
        <h3>输入您注册的电子邮箱和用户名，找回密码：</h3>
        <div id="change-password" class="hidden-wrap">
            <form action="resetchk.php" method="post">


                <div class="form-group">
                    <label for="password-again">用户名</label>
                    <input type="text" placeholder="输入您的用户名"  name="username"  class="form-control" required="required"/>
                </div>
                <div class="form-group">
                    <label for="new-password">邮件地址</label>
                    <input type="email" placeholder="请输入邮件地址" name="email" class="form-control" required="required"/>
